...
import lesson_27.enams.days.Day;
...
//    }
//    //@BeforeEach budet vipolnatsa pered kagdim testovim metodom
//     @BeforeEach
//     void setUp(){
...
//        int result = 2 + 2;
//
//        //metodi proverki utvergdenij
//        //                   ogidaemij resultat, faktich resultat
//        assertEquals(4,       result );//ravni li dva snachenija
//
//        assertNotEquals(9, result);//ne ogidaemij resultat
//
//
//
//
...
//@ValueSource(strings = {"apple", "banana", "cherry"})
//public void testFruit(String fruit){
//    System.out.println("frukt : " + fruit);
//    assertTrue(fruit.length()>2);
//}
////istochnik dannih fail v formate CSV
//
//    @ParameterizedTest
//    @CsvFileSource(resources = "data.csv")
...
//
//    static Stream<Integer> testInteger (){
//        return Stream.of(1,5,6,7,8,90);
//    }
//    @ParameterizedTest
//    @MethodSource("testMethodArguments")
//    void testMethodSource2 (int value, int extended, boolean isEquals){
//        System.out.println(value + "|" + extended + "|" + isEquals);
//        int result = value * value;
//        assertEquals(isEquals, result == extended);
//    }
//static Stream<Arguments> testMethodArguments(){
//        return Stream.of(
//                Arguments.of(2,4, true),
//                Arguments.of(3,9, true),
//                Arguments.of(4,15,false)
