...
public class Homework_03Task_1 {
    public static void main(String[] args) {
        int ageOleksii;
        ageOleksii = 44;
        System.out.println("age Oleksii: "  + ageOleksii);

        double oneLiterOfMilck;
        oneLiterOfMilck = 2;
        System.out.println("Price one Liter Of Milk " + oneLiterOfMilck);

        String alexName;
        alexName = "Oleksii";
        System.out.println("name: " + alexName);
